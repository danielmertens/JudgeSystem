...
{
    public partial class CreateDataStructure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Input = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CodeFiles_Problems_ProblemId",
                        column: x => x.ProblemId,
                        principalTable: "Problems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CodeFiles_Teams_Teamid",
                        column: x => x.Teamid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeFiles_ProblemId",
                table: "CodeFiles",
                column: "ProblemId");

            migrationBuilder.CreateIndex(
                name: "IX_CodeFiles_Teamid",
                table: "CodeFiles",
                column: "Teamid");
